...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(reso<8.0) {
            ...
            Toast.makeText(MainActivity.this,"Camera quality not good.", Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 7 && resultCode == RESULT_OK) {
           ...
           bright=calculateBrightnessEstimate(bitmap, 1); //values b/w 0 and 255 0:dark 255:white
            Toast.makeText(MainActivity.this,"Brightness:"+bright, Toast.LENGTH_LONG).show();
    ...
    public float getBackCameraResolutionInMp()
    {
        ...
        Toast.makeText(MainActivity.this,"resolution:"+maxResolution, Toast.LENGTH_LONG).show();
